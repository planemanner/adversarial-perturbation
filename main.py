...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10', choices=['SVHN', 'CIFAR10','FashionMNIST','CIFAR100'])
    parser.add_argument('--total_n_pseudo_batches', type=float, default=8000)
    ...
    parser.add_argument('--teacher_architecture', type=str, default='AlexNet')
    parser.add_argument('--student_architecture', type=str, default='AlexNet_half')
    ...
    parser.add_argument('--pretrained_models_path', nargs="?", type=str, default='/DB_ki/clean_thesis/ZeroShotKnowledgeTransfer/Pretrained/')
    parser.add_argument('--datasets_path', type=str, default="/DB_ki/clean_thesis/ZeroShotKnowledgeTransfer/Datasets/")
    parser.add_argument('--log_directory_path', type=str, default="/DB_ki/clean_thesis/ZeroShotKnowledgeTransfer/logs/")
    parser.add_argument('--save_final_model', type=str2bool, default=0)
    parser.add_argument('--save_n_checkpoints', type=int, default=0)
    parser.add_argument('--save_model_path', type=str, default="/DB_ki/clean_thesis/ZeroShotKnowledgeTransfer/logs/Saves")
    parser.add_argument('--seeds', nargs='*', type=int, default=[5,3,1])
    parser.add_argument('--workers', type=int, default=4)
    parser.add_argument('--use_gpu', type=str2bool, default=True, help='set to False to debug on cpu, using LeNets')
    parser.add_argument('--anneal_factor', type=float, default=2.5, help='annealing factor')
    parser.add_argument('--alpha', type=float, default=5, help='constraint factor')
